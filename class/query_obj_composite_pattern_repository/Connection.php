...
final class Connection
{
    ...
    public static function open($name)
    {
        ...
        if (file_exists("class/query_obj_composite_pattern_repository/Config/{$name}.ini"))
        {
            // lê o INI e retorna um array
            $db = parse_ini_file("class/query_obj_composite_pattern_repository/Config/{$name}.ini");
        }
        else
        {
